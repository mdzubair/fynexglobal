...
// //   return (
// //     <div className="min-h-screen bg-[#0f1115] flex items-center justify-center px-4 py-8 sm:py-10 overflow-y-auto">
// //       <motion.div
// //         initial={{ opacity: 0, y: 20 }}
// //         animate={{ opacity: 1, y: 0 }}
// //         className="bg-[#181a20] shadow-xl rounded-2xl p-6 sm:p-8 w-full max-w-[95%] sm:max-w-md border border-[#1f1f1f] mx-auto"
// //       >
// //         <h1 className="text-xl sm:text-2xl font-semibold text-gray-100 mb-6 text-center">
// //           Withdraw Funds
// //         </h1>
...
// //           className="bg-[#1f2128] rounded-xl p-4 mb-6 flex items-center justify-between shadow-md"
// //         >
// //           <div>
// //             <p className="text-sm text-gray-400">Available Balance</p>
// //             <p className="text-2xl font-bold text-green-400">$12,450.20</p>
// //           </div>
// //           <DollarSign size={38} style={{ color: ACCENT }} />
// //         </motion.div>
...
// //               className="w-full px-4 py-2 rounded-md bg-[#1f2128] border border-[#2a2d34] focus:border-green-500 text-gray-100 outline-none transition"
// //             />
// //           </div>
...
// //               className="w-full px-4 py-2 rounded-md bg-[#1f2128] border border-[#2a2d34] focus:border-green-500 text-gray-100 outline-none"
// //             >
...
// //               animate={{ opacity: 1, y: 0 }}
// //               exit={{ opacity: 0, y: -20 }}
// //               className="mt-6 flex flex-col items-center text-green-400"
// //             >
// //               <CheckCircle size={40} />
// //               <p className="mt-2 text-sm">Your withdrawal request was sent!</p>
// //             </motion.div>
// //           )}
// //         </AnimatePresence>
...
// //           <CreditCard className="inline-block mr-1 text-gray-400" size={14} />
// //           Withdrawals may take 1–3 business days depending on payment method.
// //         </div>
// //       </motion.div>
// //     </div>
// //   );
